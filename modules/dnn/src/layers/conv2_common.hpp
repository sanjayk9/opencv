...
// Extra spatial split for when N * <output channel blocks> alone is too few
// tasks to occupy every thread (e.g. a 32-channel blocked output is only 4).
// Returns 1 once total_blocks already saturates the pool.
